...
func TestGetLogContext(t *testing.T) {
	...
	assert.Equal(t, serviceName, context.GetServiceName(), "service name should be equal")
	...
	assert.Equal(t, rootSpan.Context().GetTraceID(), context.GetTraceID(), "trace id should be equal")
	assert.Equal(t, rootSpan.Context().GetSegmentID(), context.GetTraceSegmentID(), "trace segment id should be equal")
	assert.Equal(t, rootSpan.Context().GetSpanID(), context.GetSpanID(), "span id should be equal")
