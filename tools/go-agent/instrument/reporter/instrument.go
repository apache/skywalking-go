...
func (i *Instrument) copyReporterFiles(targetDir, reporterType string) ([]string, error) {
	...
	copiedFiles, err := tools.CopyGoFiles(core.FS, reporterDirName, targetDir, func(entry fs.DirEntry, f *dst.File) (*tools.DebugInfo, error) {
		...
		pkgUpdates["github.com/apache/skywalking-go/protocols/collect/common/v3"] = "github.com/apache/skywalking-go/protocols/collect/common/v3"
		pkgUpdates["github.com/apache/skywalking-go/protocols/collect/language/agent/v3"] = "github.com/apache/skywalking-go/protocols/collect/language/agent/v3"
		pkgUpdates["github.com/apache/skywalking-go/protocols/collect/logging/v3"] = "github.com/apache/skywalking-go/protocols/collect/logging/v3"
		pkgUpdates["github.com/apache/skywalking-go/protocols/collect/management/v3"] = "github.com/apache/skywalking-go/protocols/collect/management/v3"
		pkgUpdates["github.com/apache/skywalking-go/protocols/collect/agent/configuration/v3"] = "github.com/apache/skywalking-go/protocols/collect/agent/configuration/v3"
		tools.ChangePackageImportPath(file, pkgUpdates)
