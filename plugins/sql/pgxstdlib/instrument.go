...
func (i *Instrument) Points() []*instrument.Point {
	return []*instrument.Point{
		{
			PackagePath: "",
			At: instrument.NewMethodEnhance("*Driver", "OpenConnector",
				instrument.WithArgsCount(1), instrument.WithArgType(0, "string"),
				instrument.WithResultCount(2), instrument.WithResultType(0, "driver.Connector"), instrument.WithResultType(1, "error")),
